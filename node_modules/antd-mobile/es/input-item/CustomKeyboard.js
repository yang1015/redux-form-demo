                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(KeyboardItem, { role: 'button', 'aria-label': backspaceLabel, className: 'keyboard-delete', rowSpan: 2, onClick: this.onKeyboardClick })
                        ),
                        React.createElement(
                            'tr',
                            null,
                        ...
                        React.createElement(
                            ...
                            React.createElement(KeyboardItem, { role: 'button', 'aria-label': cancelKeyboardLabel, className: 'keyboard-hide', onClick: this.onKeyboardClick })
                        )
                    )
                )
            );
